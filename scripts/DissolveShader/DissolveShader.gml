...
function DissolveShader(argument0, argument1, argument2, argument3, argument4) {
	...
	//Example:
	draw_sprite_ext(argument0,argument1,argument2,argument3, 0.35, 0.35, 0, c_white, 1);
